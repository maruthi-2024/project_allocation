...
from .Project_view import project_viewset,Project_detail,Project_skill_detail,Employee_in_projects
...
urlpatterns=[
    ...
    path("get_user/",verify_token,name="verify token"),
    ...
    path("emp_proj",Employee_in_projects,name="employee project")
]
